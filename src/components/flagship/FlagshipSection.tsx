...
export function FlagshipSection() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      if (!containerRef.current || !stageRef.current || !introTitleRef.current || !introSubRef.current || !introRef.current) return;
  ...
  return (
    <>
      ...
      <section
        ref={containerRef}
        className="relative w-full text-white bg-gradient-to-b from-[#07090e] via-[#0a1931] to-[#07090e]"
        style={{ height: "620vh" }}
      ...
      >
        ...
        <div
          ref={stageRef}
          className="sticky top-0 w-full overflow-hidden bg-gradient-to-b from-[#07090e] via-[#0a1931] to-[#07090e]"
          style={{ height: "100svh" }}
        >
        ...
        {/* ── MOBILE ── */}
        <div className="md:hidden px-5 pb-20 bg-gradient-to-b from-[#07090e] via-[#0a1931] to-[#07090e]">
